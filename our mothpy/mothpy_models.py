...
import numpy as np
import random
from navigator_carde import carde1, carde2, crw
...
class MothModular(object):
    def __init__(self,sim_region,x,y,nav_type = 1,
                 cast_type = 'carde2', wait_type = 1, speed = 200.0,
                 beta=30, duration =0.5):
        self.x = x
        self.y = y
        self.u = 0
        self.v = 0
    ...
    beta : float
       Angle of attack
    Duration : float
       Time traveled without odor until the moth changes direction
    """
    ...
    def update_gamma(self):
        #used in navigation modes three and four
        #beta increases as odor increases
    ...
    def calculate_wind_angle(self,wind_vel_at_pos):
        #The angle of the wind as perceived from the ground. Does not use the moth's speed.
