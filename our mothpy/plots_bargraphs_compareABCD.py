...
renamed from line_graphs to plots_bargraphs_compareABCD - this file creates bar graphs that compare the different strategies specified in the Benelli et al. paper
"""

from __future__ import division
from avgtime_success import get_data
import json
import matplotlib
...
def present_graphs():
    ...
    for i in range(num_jobs):
        loop = str(i)
        data_list = get_data('sims/data'+loop+'.json',4)
        #print (data_list[0])
