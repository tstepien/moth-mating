...
def save_plot(job_file_name = 'sims/job.json',data_file_name ='sims/data1.json',
...
def save_detection_plot(job_file_name = 'sims/job.json',data_file_name ='sims/data1.json',
...
if __name__ == "__main__":
    save_plot('sims/job0.json','sims/data0.json')
