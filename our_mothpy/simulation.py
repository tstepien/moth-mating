...
def moth_simulation(num_it=10,navigators = (),t_max = 1,
                    ...
                    puff_spread_rate = 0.001,flight_speed=200,puff_mol_amount=1,
                    draw_iter_interval = 1 ,
                    prep_plume = False):
    """
    a copy of the concentration_array_demo with the moth actions integrated
    """
    ...
    difference list dictionary is a dictionary containing lists, each list represents a different moth
    and each item in the list is a tuple of the form (x,y,T,odor found/odor lost/none, is turning/isn't turning)
    """
    diff_dict_lst =[]
    #this shamefully large tree transcribes the lists to the lists accounting for the moments of finding and losing odor
